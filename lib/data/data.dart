...
final users = [
  ...
  User(
    ...
    backgroundImageUrl: 'assets/images/post2.jpg',
    name: 'Thomas',
    following: 2000,
    followers: 1504,
    posts: _yourPosts,
  ...
  User(
    ...
    backgroundImageUrl: 'assets/images/post3.jpg',
    name: 'Emma',
    following: 600,
    followers: 250,
    posts: _yourPosts,
  ...
  User(
    ...
    backgroundImageUrl: 'assets/images/post4.jpg',
    name: 'Olivia',
    following: 600,
    followers: 250,
    posts: _yourPosts,
  ...
  User(
    ...
    backgroundImageUrl: 'assets/images/post5.jpg',
    name: 'Charles',
    following: 100,
    followers: 120,
    posts: _yourPosts,
